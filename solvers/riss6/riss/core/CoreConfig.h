...
class CoreConfig : public Config
{
  ...
  public:
    ...
    */
    ...
    BoolOption opt_fastReduce; // better way to remove learned clauses during reduceDB
    ...
    IntOption  opt_receiveEvery;          // after how many conflicts should a receive be triggered again?
