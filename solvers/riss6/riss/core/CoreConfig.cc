...
CoreConfig::CoreConfig(const std::string& presetOptions)  // add new options here!
    ...
    opt_fastReduce   (_cat, "rdf", "use fast reduce", false,                                                        optionListPtr),
    ...
    opt_receiveEvery            ("CLAUSE SHARING", "recCon",     "Receive every X conflicts", 128, IntRange(1, INT32_MAX) ,                                                                                    optionListPtr),
 ...
 debug_otfss ("SEARCH -- OTFSS", "otfss-d", "print debug output", false, optionListPtr ),
    ...
    opt_binaryProof     ("CORE -- PROOF", "binProof",        "write proof in binary format #NoAutoT", false,                                                                   optionListPtr),
